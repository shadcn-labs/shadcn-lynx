...
__webpack_require__.add({
	"./src/commands/app.ts"(
		...
		var _utils_ts__rspack_import_0 = __webpack_require__(
		...
		function registerAppCommand(program, connector) {
			program
				...
				.action(async (paramsStr, options) => {
					...
					if (!clientId)
						clientId = await (0, _utils_ts__rspack_import_0.a)(connector);
			...
			program
				...
				.action(async (paramsStr, options) => {
					...
					if (!clientId)
						clientId = await (0, _utils_ts__rspack_import_0.a)(connector);
					if (!sessionId)
						sessionId = await (0, _utils_ts__rspack_import_0.k)(
							connector,
							clientId,
						);
					const params = paramsStr ? JSON.parse(paramsStr) : {};
	...
	"./src/commands/get-console.ts"(
		...
		var node_stream_web__rspack_import_0 =
			__webpack_require__("node:stream/web");
		var node_timers_promises__rspack_import_1 = __webpack_require__(
			"node:timers/promises",
		);
		var _utils_ts__rspack_import_2 = __webpack_require__(
			"./src/commands/utils.ts",
		);
			...
			program
				...
				.action(async (options) => {
					...
					try {
						...
						if (!clientId)
							clientId = await (0, _utils_ts__rspack_import_2.a)(connector);
						if (!sessionId)
							sessionId = await (0, _utils_ts__rspack_import_2.k)(
								connector,
								clientId,
							);
						const numericSessionId = Number(sessionId);
						const stream = _ts_add_disposable_resource(
							env,
							await connector.sendCDPStream(
								clientId,
								node_stream_web__rspack_import_0.ReadableStream.from([
									{
						...
						try {
							while (Date.now() - startTime < MAX_TOTAL_TIME) {
								const result = await Promise.race([
									reader.read(),
									(0, node_timers_promises__rspack_import_1.setTimeout)(
										IDLE_TIMEOUT,
										"timeout",
									),
								]);
								...
								if ("Runtime.consoleAPICalled" === value.method) {
									...
									if (allowedLevels.includes(params.type)) {
										...
										if (!includeStackTraces && "error" !== params.type)
				...
				.action(async (options) => {
					...
					try {
						...
						const stream = _ts_add_disposable_resource(
							...
							await connector.sendCDPStream(
								clientId,
								node_stream_web__rspack_import_0.ReadableStream.from(messages),
							),
							true,
						);
						const scripts = [];
						...
						try {
							while (Date.now() - startTime < MAX_TOTAL_TIME) {
								...
								const { done, value } = result;
								if (done) break;
								if ("Debugger.scriptParsed" === value.method)
									scripts.push(value.params);
							}
						} finally {
							reader.releaseLock();
						}
	...
	"./src/commands/take-screenshot.ts"(
		__unused_rspack_module,
		__webpack_exports__,
		__webpack_require__,
	) {
		...
		var node_fs_promises__rspack_import_0 =
			__webpack_require__("node:fs/promises");
		var node_stream_web__rspack_import_1 =
			__webpack_require__("node:stream/web");
		var node_timers_promises__rspack_import_2 = __webpack_require__(
			"node:timers/promises",
		);
		var _utils_ts__rspack_import_3 = __webpack_require__(
			"./src/commands/utils.ts",
		);
		function _ts_add_disposable_resource(env, value, async) {
			if (null != value) {
			...
			program
				...
				.action(async (options) => {
					...
					try {
						...
						if (!clientId)
							clientId = await (0, _utils_ts__rspack_import_3.a)(connector);
						if (!sessionId)
							sessionId = await (0, _utils_ts__rspack_import_3.k)(
								connector,
								clientId,
							);
						const numericSessionId = Number(sessionId);
						...
						const stream = _ts_add_disposable_resource(
							...
							await connector.sendCDPStream(
								clientId,
								new node_stream_web__rspack_import_1.ReadableStream({
									async start(controller) {
										...
										await Promise.race([
											promise,
											(0, node_timers_promises__rspack_import_2.setTimeout)(
												10000,
												void 0,
												{
													ref: false,
						...
						for await (const { method, params: eventParams } of stream)
							if ("Page.screencastFrame" === method) {
								const { data } = eventParams;
								if (data) {
									resolve();
									const fileName = output ?? `screenshot-${Date.now()}.jpeg`;
									await node_fs_promises__rspack_import_0["default"].writeFile(
										fileName,
	...
	"./src/devtool.ts"(
		...
		var commander__rspack_import_0 = __webpack_require__(
			"../../../node_modules/.pnpm/commander@14.0.3/node_modules/commander/esm.mjs",
		);
		var _package_json__rspack_import_1 = __webpack_require__("./package.json");
		var _commands_app_ts__rspack_import_8 = __webpack_require__(
			"./src/commands/app.ts",
		);
		var _commands_cdp_ts__rspack_import_7 = __webpack_require__(
			"./src/commands/cdp.ts",
		);
		var _commands_get_console_ts__rspack_import_2 = __webpack_require__(
			"./src/commands/get-console.ts",
		);
		var _commands_get_sources_ts__rspack_import_3 = __webpack_require__(
			"./src/commands/get-sources.ts",
		);
		var _commands_list_clients_ts__rspack_import_5 = __webpack_require__(
			"./src/commands/list-clients.ts",
		);
		var _commands_list_sessions_ts__rspack_import_6 = __webpack_require__(
			"./src/commands/list-sessions.ts",
		);
		var _commands_open_ts__rspack_import_9 = __webpack_require__(
			"./src/commands/open.ts",
		);
		var _commands_take_screenshot_ts__rspack_import_4 = __webpack_require__(
			"./src/commands/take-screenshot.ts",
		);
		function createProgram(connector, transports) {
			...
			program
				...
				.version(_package_json__rspack_import_1.rE)
	...
	"./src/index.ts"(module, __webpack_exports__, __webpack_require__) {
		__webpack_require__.a(
			module,
			async (__rspack_load_async_deps, __rspack_async_done) => {
				try {
					__webpack_require__.r(__webpack_exports__);
					var _lynx_js_devtool_connector__rspack_import_0 = __webpack_require__(
						"../../../node_modules/.pnpm/@lynx-js+devtool-connector@0.1.0/node_modules/@lynx-js/devtool-connector/dist/index.js",
					);
					var _lynx_js_devtool_connector_transport__rspack_import_1 =
						__webpack_require__(
							"../../../node_modules/.pnpm/@lynx-js+devtool-connector@0.1.0/node_modules/@lynx-js/devtool-connector/dist/transport/index.js",
						);
					var _devtool_ts__rspack_import_2 =
						__webpack_require__("./src/devtool.ts");
					function getAndroidTransportSpec() {
						const port = Number.parseInt(
							process.env.ADB_SERVER_PORT ?? "5037",
							10,
						);
						return {
					...
					const transports = [
						new _lynx_js_devtool_connector_transport__rspack_import_1.Ry(
							getAndroidTransportSpec(),
						),
						new _lynx_js_devtool_connector_transport__rspack_import_1.y4(),
						new _lynx_js_devtool_connector_transport__rspack_import_1.HS(),
					];
					const connector = new _lynx_js_devtool_connector__rspack_import_0.Wi(
						transports,
					);
					await (0, _devtool_ts__rspack_import_2.r)(
						connector,
						transports,
	...
	"../../../node_modules/.pnpm/commander@14.0.3/node_modules/commander/lib/command.js"(
		...
		const { Help, stripColor } = __webpack_require__(
			"../../../node_modules/.pnpm/commander@14.0.3/node_modules/commander/lib/help.js",
		);
		...
		class Command extends EventEmitter {
			constructor(name) {
				...
				this._outputConfiguration = {
					...
					getOutHelpWidth: () =>
						process1.stdout.isTTY ? process1.stdout.columns : void 0,
					getErrHelpWidth: () =>
						process1.stderr.isTTY ? process1.stderr.columns : void 0,
					getOutHasColors: () =>
						useColor() ??
						(process1.stdout.isTTY && process1.stdout.hasColors?.()),
					getErrHasColors: () =>
						useColor() ??
						(process1.stderr.isTTY && process1.stderr.hasColors?.()),
...
- specify the name in Command constructor or using .name()`);
			...
			addArgument(argument) {
				...
				if (
					argument.required &&
					void 0 !== argument.defaultValue &&
					void 0 === argument.parseArg
				)
					throw new Error(
...
-  already used by option '${matchingOption.flags}'`);
				...
				if (option.negate) {
					...
					if (!this._findOption(positiveLongFlag))
						this.setOptionValueWithSource(
							name,
							void 0 === option.defaultValue ? true : option.defaultValue,
							"default",
						);
				} else if (void 0 !== option.defaultValue)
					this.setOptionValueWithSource(name, option.defaultValue, "default");
				const handleOptionValue = (val, invalidValueMessage, valueSource) => {
					if (null == val && void 0 !== option.presetArg)
						val = option.presetArg;
					const oldValue = this.getOptionValue(name);
					if (null !== val && option.parseArg)
					...
					else if (null !== val && option.variadic)
						val = option._collectValue(val, oldValue);
					if (null == val)
						val = option.negate
							? false
							: option.isBoolean() || option.optional
								? true
								: "";
			...
			_optionEx(config, flags, description, fn, defaultValue) {
				if ("object" == typeof flags && flags instanceof Option)
					throw new Error(
			...
			getOptionValueSourceWithGlobals(key) {
				...
				this._getCommandAndAncestors().forEach((cmd) => {
					if (void 0 !== cmd.getOptionValueSource(key))
						source = cmd.getOptionValueSource(key);
				});
				return source;
			}
			_prepareUserArgs(argv, parseOptions) {
				if (void 0 !== argv && !Array.isArray(argv))
					throw new Error(
 ...
 - ${executableDirMessage}`;
			...
			_executeSubCommand(subcommand, args) {
				...
				if (!proc.killed) {
					...
					signals.forEach((signal) => {
						process1.on(signal, () => {
							if (false === proc.killed && null === proc.exitCode)
								proc.kill(signal);
						});
					});
				}
			...
			_checkNumberOfArguments() {
				this.registeredArguments.forEach((arg, i) => {
					if (arg.required && null == this.args[i])
			...
			_chainOrCall(promise, fn) {
				if (promise?.then && "function" == typeof promise.then)
			...
			_chainOrCallHooks(promise, event) {
				...
				this._getCommandAndAncestors()
					.reverse()
					.filter((cmd) => void 0 !== cmd._lifeCycleHooks[event])
			...
			_chainOrCallSubCommandHook(promise, subCommand, event) {
				let result = promise;
				if (void 0 !== this._lifeCycleHooks[event])
			...
			_checkForMissingMandatoryOptions() {
				this._getCommandAndAncestors().forEach((cmd) => {
					cmd.options.forEach((anOption) => {
						if (
							anOption.mandatory &&
							void 0 === cmd.getOptionValue(anOption.attributeName())
						)
			...
			parseOptions(args) {
				...
				while (i < args.length || activeGroup) {
					...
					if (
						dest === operands &&
						maybeOption(arg) &&
						!(0 === this.commands.length && negativeNumberArg(arg))
					)
						dest = unknown;
					if (
			...
			error(message, errorOptions) {
				...
				if ("string" == typeof this._showHelpAfterError)
			...
			_conflictingOption(option, conflictingOption) {
				const findBestOptionFromValue = (option) => {
					...
					if (
						negativeOption &&
						((void 0 === negativeOption.presetArg && false === optionValue) ||
							(void 0 !== negativeOption.presetArg &&
			...
			description(str, argsDescription) {
				if (void 0 === str && void 0 === argsDescription)
			...
			usage(str) {
				if (void 0 === str) {
					...
					return []
						.concat(
							this.options.length || null !== this._helpOption
								? "[options]"
								: [],
			...
			help(contextOptions) {
				...
				if (
					0 === exitCode &&
					contextOptions &&
					"function" != typeof contextOptions &&
...
Expecting one of '${allowedValues.join("', '")}'`);
		...
		function incrementNodeInspectorPort(args) {
			return args.map((arg) => {
				...
				let debugPort = "9229";
				let match;
				if (null !== (match = arg.match(/^(--inspect(-brk)?)$/)))
					debugOption = match[1];
				else if (
					null !== (match = arg.match(/^(--inspect(-brk|-port)?)=([^:]+)$/))
				) {
					debugOption = match[1];
		...
		function useColor() {
			if (
				process1.env.NO_COLOR ||
				"0" === process1.env.FORCE_COLOR ||
				"false" === process1.env.FORCE_COLOR
			)
				return false;
			if (process1.env.FORCE_COLOR || void 0 !== process1.env.CLICOLOR_FORCE)
				return true;
		}
		exports.Command = Command;
	...
	"../../../node_modules/.pnpm/commander@14.0.3/node_modules/commander/lib/help.js"(
		...
		class Help {
			...
			optionDescription(option) {
				...
				if (void 0 !== option.defaultValue) {
					const showDefault =
						option.required ||
						option.optional ||
						(option.isBoolean() && "boolean" == typeof option.defaultValue);
					if (showDefault)
						extraInfo.push(
							`default: ${option.defaultValueDescription || JSON.stringify(option.defaultValue)}`,
						);
				}
				if (void 0 !== option.presetArg && option.optional)
			...
			argumentDescription(argument) {
				...
				if (void 0 !== argument.defaultValue)
					extraInfo.push(
	...
	"../../../node_modules/.pnpm/commander@14.0.3/node_modules/commander/lib/option.js"(
		...
		class Option {
			...
			implies(impliedOptionValues) {
				...
				if ("string" == typeof impliedOptionValues)
					newImplied = {
...
- unrecognised flag format`);
			...
			if (void 0 === shortFlag && void 0 === longFlag)
				throw new Error(
	...
	"../../../node_modules/.pnpm/@lynx-js+devtool-connector@0.1.0/node_modules/@lynx-js/devtool-connector/dist/844.js"(
		__unused_rspack___webpack_module__,
		__unused_rspack___webpack_exports__,
		__webpack_require__,
	) {
		...
		var _rslib_runtime_js__rspack_import_3 = __webpack_require__(
			"../../../node_modules/.pnpm/@lynx-js+devtool-connector@0.1.0/node_modules/@lynx-js/devtool-connector/dist/rslib-runtime.js",
		);
		_rslib_runtime_js__rspack_import_3.Q.add({
			"../../../node_modules/.pnpm/debug@4.4.3/node_modules/debug/src/browser.js"(
				...
				function load() {
					...
					if (!r && "u" > typeof process && "env" in process)
						r = process.env.DEBUG;
					return r;
				}
				...
				module.exports = (0, _rslib_runtime_js__rspack_import_3.Q)(
			...
			"../../../node_modules/.pnpm/debug@4.4.3/node_modules/debug/src/common.js"(
				...
				function setup(env) {
					...
					createDebug.humanize = (0, _rslib_runtime_js__rspack_import_3.Q)(
			...
			"../../../node_modules/.pnpm/debug@4.4.3/node_modules/debug/src/node.js"(
				...
				try {
					const supportsColor = (0, _rslib_runtime_js__rspack_import_3.Q)(
			...
			"../../../node_modules/.pnpm/supports-color@8.1.1/node_modules/supports-color/index.js"(
				...
				const tty = (0, _rslib_runtime_js__rspack_import_3.Q)("tty");
				const hasFlag = (0, _rslib_runtime_js__rspack_import_3.Q)(
					"../../../node_modules/.pnpm/has-flag@4.0.0/node_modules/has-flag/index.js",
				);
				const { env } = process;
				let flagForceColor;
				...
				function envForceColor() {
					if ("FORCE_COLOR" in env) {
						...
						return 0 === env.FORCE_COLOR.length
							? 1
	...
	"../../../node_modules/.pnpm/@lynx-js+devtool-connector@0.1.0/node_modules/@lynx-js/devtool-connector/dist/index.js"(
		...
		var _rslib_runtime_js__rspack_import_0 = __webpack_require__(
			"../../../node_modules/.pnpm/@lynx-js+devtool-connector@0.1.0/node_modules/@lynx-js/devtool-connector/dist/rslib-runtime.js",
		);
		var node_crypto__rspack_import_1 = __webpack_require__("node:crypto");
		var node_stream_web__rspack_import_2 =
			__webpack_require__("node:stream/web");
		var node_fs_promises__rspack_import_3 =
			__webpack_require__("node:fs/promises");
		...
		function isListSessionResponse(response) {
			return (
				"Customized" === response.event && "SessionList" === response.data.type
			);
		}
			...
			constructor(options) {
				...
				super({
					transform(chunk, controller) {
						const sid =
							"function" == typeof sessionId ? sessionId(chunk) : sessionId;
						controller.enqueue({
							event: "Customized",
							data: {
								type,
				...
				super({
					checkError: (message) => {
						try {
							...
							if (0 !== result.code && "0" !== result.code)
								return new Error(
									`App request ${method} error: ${result.message}`,
									{
										cause: message,
									},
								);
			...
			constructor(port, fixedId) {
				super({
					...
					messageBuilder: (chunk) => {
						const id =
							fixedId ??
							(0, node_crypto__rspack_import_1.randomInt)(10000, 50000);
		...
		const src = (0, _rslib_runtime_js__rspack_import_0.Q)(
			"../../../node_modules/.pnpm/debug@4.4.3/node_modules/debug/src/index.js",
		);
		var src_default = /*#__PURE__*/ _rslib_runtime_js__rspack_import_0.Q.n(src);
		const debug = src_default()("devtool-mcp-server:takeover");
		const DEBUG_ROUTER_DIR = node_path__rspack_import_5["default"].join(
			node_os__rspack_import_4["default"].homedir(),
			".DebugRouterConnector",
		);
		const DEBUG_ROUTER_LOCK_DIR = node_path__rspack_import_5["default"].join(
			DEBUG_ROUTER_DIR,
			"lockfile",
		);
		const DEBUG_ROUTER_LATEST_FILE = node_path__rspack_import_5["default"].join(
			DEBUG_ROUTER_DIR,
			"LatestDriverProcess",
		);
		async function takeoverDebugRouterLock() {
			try {
				await node_fs_promises__rspack_import_3["default"].mkdir(
					DEBUG_ROUTER_DIR,
					{
						recursive: true,
					},
				);
				await node_fs_promises__rspack_import_3["default"].rm(
					DEBUG_ROUTER_LOCK_DIR,
					{
						recursive: true,
						force: true,
					},
				...
				await node_fs_promises__rspack_import_3["default"].writeFile(
					DEBUG_ROUTER_LATEST_FILE,
					`${process.pid}`,
					"utf-8",
				);
		...
		function src_ts_dispose_resources(env) {
			...
			return (src_ts_dispose_resources = (env) => {
				function fail(e) {
					env.error = env.hasError
						? new _SuppressedError(
								e,
		...
		class ClientId {
			...
			static deserialize(clientId) {
				try {
					...
					const port = Number.parseInt(
						clientId.substring(lastColonIndex + 1),
						10,
					);
		...
		class Connector {
			...
			async listDevices() {
				...
				return results
					.filter((result) => "fulfilled" === result.status)
					.flatMap(({ value }) => value);
			}
			...
			async openApp(deviceId, packageName, options) {
				...
				const signal = AbortSignal.any(
					[options?.signal, AbortSignal.timeout(60000)].filter(
						(i) => void 0 !== i,
					),
				);
				const { setTimeout: setTimeout1 } = await import(
					"node:timers/promises"
				);
				while (!signal.aborted) {
					try {
						const clients = await this.#listClientsForDevice(
							transport,
							deviceId,
						);
						if (
							clients.some(
								({ info }) =>
									info.AppProcessName === packageName ||
						...
						src_debug(
							`openApp ${deviceId} ${packageName} client not found %o`,
							err,
						);
					}
			...
			async sendCDPMessage(clientId, sessionId, method, params) {
				...
				return await this.#sendMessage(
					...
					{
						input: [new CDPRequestTransformStream(port, id)],
						output: [
			...
			async getGlobalSwitch(clientId, key) {
				...
				if ("object" == typeof message)
					return (
						message?.global_value === "true" || message?.global_value === true
					);
			...
			async sendCDPStream(clientId, inputStream, { signal } = {}) {
				...
				return await this.#connect(
					...
					inputStream,
					{
						input: [new CDPRequestTransformStream(port)],
			...
			async #connect(transport, options, inputStream, pipeline) {
				...
				[
					...
					new InspectStream((msg) =>
						src_debug(`connect ${deviceId}:${port} input stream send %O`, msg),
					),
				...
				const outputStream = [
					...
					new InspectStream((msg) =>
						src_debug(
							`connect ${deviceId}:${port} output stream receive %O`,
							msg,
						),
					),
					...pipeline.output,
			...
			async #sendMessageWithTransport(transport, options, input, pipeline) {
				...
				try {
					const outputStream = _ts_add_disposable_resource(
						env,
						await this.#connect(
							transport,
							options,
							node_stream_web__rspack_import_2.ReadableStream.from([input]),
							pipeline,
						),
						true,
					);
	...
	"../../../node_modules/.pnpm/@lynx-js+devtool-connector@0.1.0/node_modules/@lynx-js/devtool-connector/dist/rslib-runtime.js"(
		...
		function __nested_rspack_require_65__(moduleId) {
			...
			__webpack_modules__[moduleId].call(
				...
				module,
				module.exports,
				__nested_rspack_require_65__,
			);
			return module.exports;
		}
		__nested_rspack_require_65__.m = __webpack_modules__;
		(() => {
			__nested_rspack_require_65__.add = (modules) => {
		...
		(() => {
			__nested_rspack_require_65__.d = (exports, definition) => {
				for (var key in definition)
					if (
						__nested_rspack_require_65__.o(definition, key) &&
						!__nested_rspack_require_65__.o(exports, key)
					)
		...
		(() => {
			__nested_rspack_require_65__.o = (obj, prop) => Object.hasOwn(obj, prop);
		})();
	},
	"../../../node_modules/.pnpm/@lynx-js+devtool-connector@0.1.0/node_modules/@lynx-js/devtool-connector/dist/transport/index.js"(
		__unused_rspack___webpack_module__,
		...
		var _rslib_runtime_js__rspack_import_1 = __webpack_require__(
			"../../../node_modules/.pnpm/@lynx-js+devtool-connector@0.1.0/node_modules/@lynx-js/devtool-connector/dist/rslib-runtime.js",
		);
		...
		_rslib_runtime_js__rspack_import_1.Q.add({
			"../../../node_modules/.pnpm/@httptoolkit+util@0.1.9/node_modules/@httptoolkit/util/dist/errors.js"(
				__unused_rspack_module,
				exports,
			) {
			...
			"../../../node_modules/.pnpm/@httptoolkit+util@0.1.9/node_modules/@httptoolkit/util/dist/index.js"(
				__unused_rspack_module,
				exports,
				__webpack_require__,
			) {
				...
				var __exportStar =
					...
					((m, exports) => {
						for (var p in m)
							if ("default" !== p && !Object.hasOwn(exports, p))
				...
				__exportStar(
					(0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/@httptoolkit+util@0.1.9/node_modules/@httptoolkit/util/dist/promises.js",
					),
					exports,
				);
				__exportStar(
				...
				__exportStar(
					(0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/@httptoolkit+util@0.1.9/node_modules/@httptoolkit/util/dist/text.js",
					),
					exports,
				);
			},
			...
			"../../../node_modules/.pnpm/@xmldom+xmldom@0.8.11/node_modules/@xmldom/xmldom/lib/conventions.js"(
				...
				function freeze(object, oc) {
					...
					return oc && "function" == typeof oc.freeze
						? oc.freeze(object)
						: object;
				}
			...
			"../../../node_modules/.pnpm/@xmldom+xmldom@0.8.11/node_modules/@xmldom/xmldom/lib/dom-parser.js"(
				...
				var conventions = (0, _rslib_runtime_js__rspack_import_1.Q)(
					"../../../node_modules/.pnpm/@xmldom+xmldom@0.8.11/node_modules/@xmldom/xmldom/lib/conventions.js",
				);
				var dom = (0, _rslib_runtime_js__rspack_import_1.Q)(
					"../../../node_modules/.pnpm/@xmldom+xmldom@0.8.11/node_modules/@xmldom/xmldom/lib/dom.js",
				);
				var entities = (0, _rslib_runtime_js__rspack_import_1.Q)(
					"../../../node_modules/.pnpm/@xmldom+xmldom@0.8.11/node_modules/@xmldom/xmldom/lib/entities.js",
				);
				var sax = (0, _rslib_runtime_js__rspack_import_1.Q)(
			...
			"../../../node_modules/.pnpm/@xmldom+xmldom@0.8.11/node_modules/@xmldom/xmldom/lib/dom.js"(
				...
				function orderedSetReducer(current, element) {
					if (!Object.hasOwn(current, element)) current[element] = true;
					return current;
				}
				...
				function arrayIncludes(list) {
					return (element) => list && -1 !== list.indexOf(element);
				}
				function copy(src, dest) {
					for (var p in src) if (Object.hasOwn(src, p)) dest[p] = src[p];
				}
				function _extends(Class, Super) {
					...
					if (pt.constructor != Class) {
						if ("function" != typeof Class)
							console1.error("unknown Class:" + Class);
					...
					if (list._inc !== inc) {
						...
						if (!list.$$length || ls.length < list.$$length) {
							for (var i = ls.length; i in list; i++)
								if (Object.hasOwn(list, i)) delete list[i];
						}
						copy(ls, list);
						list._inc = inc;
					}
				...
				DOMImplementation.prototype = {
					hasFeature: (feature, version) => true,
				...
				Node.prototype = {
					...
					lookupPrefix: function (namespaceURI) {
						...
						while (el) {
							...
							if (map) {
								for (var n in map)
									if (Object.hasOwn(map, n) && map[n] === namespaceURI)
										return n;
							}
							el =
					...
					lookupNamespaceURI: function (prefix) {
						...
						while (el) {
							var map = el._nsMap;
							if (map) {
								if (Object.hasOwn(map, prefix)) return map[prefix];
							}
							el =
								el.nodeType == ATTRIBUTE_NODE
									? el.ownerDocument
				...
				function _visitNode(node, callback) {
					...
					if ((node = node.firstChild))
						do if (_visitNode(node, callback)) return true;
						...
						function getTextContent(node) {
							switch (node.nodeType) {
								...
								case DOCUMENT_FRAGMENT_NODE: {
									...
									while (node) {
										if (7 !== node.nodeType && 8 !== node.nodeType)
			...
			"../../../node_modules/.pnpm/@xmldom+xmldom@0.8.11/node_modules/@xmldom/xmldom/lib/entities.js"(
				...
				var freeze = (0, _rslib_runtime_js__rspack_import_1.Q)(
					"../../../node_modules/.pnpm/@xmldom+xmldom@0.8.11/node_modules/@xmldom/xmldom/lib/conventions.js",
				).freeze;
			...
			"../../../node_modules/.pnpm/@xmldom+xmldom@0.8.11/node_modules/@xmldom/xmldom/lib/index.js"(
				...
				exports.DOMParser = (0, _rslib_runtime_js__rspack_import_1.Q)(
					"../../../node_modules/.pnpm/@xmldom+xmldom@0.8.11/node_modules/@xmldom/xmldom/lib/dom-parser.js",
				).DOMParser;
			},
			"../../../node_modules/.pnpm/@xmldom+xmldom@0.8.11/node_modules/@xmldom/xmldom/lib/sax.js"(
				...
				var NAMESPACE = (0, _rslib_runtime_js__rspack_import_1.Q)(
					"../../../node_modules/.pnpm/@xmldom+xmldom@0.8.11/node_modules/@xmldom/xmldom/lib/conventions.js",
				).NAMESPACE;
				var nameStartChar =
				...
				function parse(
					...
					function fixedFromCharCode(code) {
						...
						var surrogate1 = 0xd800 + (code >> 10),
							surrogate2 = 0xdc00 + (0x3ff & code);
						return String.fromCharCode(surrogate1, surrogate2);
					}
					function entityReplacer(a) {
						var k = a.slice(1, -1);
						if (Object.hasOwn(entityMap, k)) return entityMap[k];
						if ("#" === k.charAt(0))
				...
				function parseElementStartPart(
					...
					function addAttribute(qname, value, startIndex) {
						if (Object.hasOwn(el.attributeNames, qname))
				...
				function _copy(source, target) {
					for (var n in source)
						if (Object.hasOwn(source, n)) target[n] = source[n];
				}
			...
			"../../../node_modules/.pnpm/plist@3.1.0/node_modules/plist/index.js"(
				...
				var parserFunctions = (0, _rslib_runtime_js__rspack_import_1.Q)(
					"../../../node_modules/.pnpm/plist@3.1.0/node_modules/plist/lib/parse.js",
				);
				Object.keys(parserFunctions).forEach((k) => {
					exports[k] = parserFunctions[k];
				});
				var builderFunctions = (0, _rslib_runtime_js__rspack_import_1.Q)(
					"../../../node_modules/.pnpm/plist@3.1.0/node_modules/plist/lib/build.js",
				);
				Object.keys(builderFunctions).forEach((k) => {
			...
			"../../../node_modules/.pnpm/plist@3.1.0/node_modules/plist/lib/build.js"(
				...
				var base64 = (0, _rslib_runtime_js__rspack_import_1.Q)(
					"../../../node_modules/.pnpm/base64-js@1.5.1/node_modules/base64-js/index.js",
				);
				var xmlbuilder = (0, _rslib_runtime_js__rspack_import_1.Q)(
				...
				function walk_obj(next, next_child) {
					...
					if (Array.isArray(next)) {
						...
						next_child
							.ele("data")
							.raw(
								base64.fromByteArray(new Uint8Array(next.buffer), next_child),
							);
			...
			"../../../node_modules/.pnpm/plist@3.1.0/node_modules/plist/lib/parse.js"(
				...
				const { DOMParser } = (0, _rslib_runtime_js__rspack_import_1.Q)(
					"../../../node_modules/.pnpm/@xmldom+xmldom@0.8.11/node_modules/@xmldom/xmldom/lib/index.js",
				);
				exports.parse = parse;
				var TEXT_NODE = 3;
				...
				function parse(xml) {
					...
					invariant(
						"plist" === doc.documentElement.nodeName,
				...
				function parsePlistXML(node) {
					...
					if ("#text" === node.nodeName);
						...
						invariant(
							"__proto__" !== node.childNodes[0].nodeValue,
			...
			"../../../node_modules/.pnpm/usbmux-client@0.2.1/node_modules/usbmux-client/dist/index.js"(
				__unused_rspack_module,
				exports,
				__webpack_require__,
			) {
				...
				const plist = (0, _rslib_runtime_js__rspack_import_1.Q)(
					"../../../node_modules/.pnpm/plist@3.1.0/node_modules/plist/index.js",
				);
				const util_1 = (0, _rslib_runtime_js__rspack_import_1.Q)(
					"../../../node_modules/.pnpm/@httptoolkit+util@0.1.9/node_modules/@httptoolkit/util/dist/index.js",
				);
				const stream_utils_1 = (0, _rslib_runtime_js__rspack_import_1.Q)(
					"../../../node_modules/.pnpm/usbmux-client@0.2.1/node_modules/usbmux-client/dist/stream-utils.js",
				);
				...
				const readMessageFromLockdowndStream = async (stream) => {
					...
					const payload = await (0, stream_utils_1.readBytes)(
						stream,
						payloadLength,
					);
					...
					if (data.Error)
						throw new Error(
							`Received lockdown error: ${data.Error.toString()}`,
						);
					return data;
				};
				...
				class UsbmuxClient {
					...
					async startListeningForDevices() {
						...
						if (this.deviceMonitorConnection?.then)
							return this.deviceMonitorConnection;
					...
					async listenToMessages(socket) {
						while (true) {
							...
							if ("Attached" === message.MessageType)
								this.deviceData[message.DeviceID] = message.Properties;
							else if ("Detached" === message.MessageType)
					...
					async close() {
						if (this.deviceMonitorConnection instanceof net.Socket)
							...
							await this.deviceMonitorConnection
								...
								.catch(() => {});
						await Promise.all(
							this.openTunnels.map((tunnel) => tunnel.destroy()),
						);
						this.deviceData = {};
					}
					...
					async getLockdownTunnel(deviceId) {
						...
						if (response?.Type !== "com.apple.mobile.lockdown")
							throw new Error(`Unexpected lockdown response: ${response}`);
						return tunnel;
					}
			...
			"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/Utility.js"(
				...
				(() => {
					...
					assign = function (target, ...sources) {
						...
						if (isFunction(Object.assign)) Object.assign.apply(null, arguments);
							...
							for (i = 0, len = sources.length; i < len; i++) {
								...
								if (null != source) {
									for (key in source)
										if (hasProp.call(source, key)) target[key] = source[key];
								}
							}
						return target;
					};
					isFunction = (val) =>
						!!val &&
						"[object Function]" === Object.prototype.toString.call(val);
					isObject = (val) => {
						var ref;
						return (
							!!val && ("function" === (ref = typeof val) || "object" === ref)
						);
					};
					isArray = (val) => {
			...
			"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLAttribute.js"(
				...
				(function () {
					var NodeType;
					NodeType = (0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/NodeType.js",
					);
					(0, _rslib_runtime_js__rspack_import_1.Q)(
			...
			"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLCData.js"(
				...
				(() => {
					...
					XMLCharacterData = (0, _rslib_runtime_js__rspack_import_1.Q)(
			...
			"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLCharacterData.js"(
				...
				(function () {
					var XMLNode;
					XMLNode = (0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLNode.js",
					);
					module.exports = (() => {
			...
			"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLDOMConfiguration.js"(
				...
				(function () {
					...
					XMLDOMErrorHandler = (0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLDOMErrorHandler.js",
					);
					XMLDOMStringList = (0, _rslib_runtime_js__rspack_import_1.Q)(
			...
			"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLDTDEntity.js"(
				...
				(function () {
					...
					({ isObject } = (0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/Utility.js",
					));
					XMLNode = (0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLNode.js",
			...
			"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLDocType.js"(
				...
				(function () {
					...
					XMLDTDAttList = (0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLDTDAttList.js",
					);
					XMLDTDEntity = (0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLDTDEntity.js",
					);
					XMLDTDElement = (0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLDTDElement.js",
					);
					XMLDTDNotation = (0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLDTDNotation.js",
					);
					XMLNamedNodeMap = (0, _rslib_runtime_js__rspack_import_1.Q)(
					...
					module.exports = (() => {
						class XMLDocType extends XMLNode {
							constructor(parent, pubID, sysID) {
								...
								if (null == sysID) [sysID, pubID] = [pubID, sysID];
			...
			"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLDocument.js"(
				...
				(function () {
					var NodeType,
						...
						XMLStringifier,
						isPlainObject;
					({ isPlainObject } = (0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/Utility.js",
					));
					XMLDOMImplementation = (0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLDOMImplementation.js",
					);
					XMLDOMConfiguration = (0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLDOMConfiguration.js",
					);
					XMLNode = (0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLNode.js",
					...
					XMLStringifier = (0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLStringifier.js",
					);
					XMLStringWriter = (0, _rslib_runtime_js__rspack_import_1.Q)(
						...
						Object.defineProperty(XMLDocument.prototype, "xmlStandalone", {
							get: function () {
								if (
									...
									return "yes" === this.children[0].standalone;
								return false;
							},
						});
			...
			"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLDocumentCB.js"(
				...
				(() => {
					var NodeType,
						...
						isPlainObject,
						hasProp = {}.hasOwnProperty;
					({ isObject, isFunction, isPlainObject, getValue } = (0,
					_rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/Utility.js",
					));
					NodeType = (0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/NodeType.js",
					);
					XMLDocument = (0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLDocument.js",
					);
					XMLElement = (0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLElement.js",
					);
					XMLCData = (0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLCData.js",
					);
					XMLComment = (0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLComment.js",
					);
					XMLRaw = (0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLRaw.js",
					);
					XMLText = (0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLText.js",
					);
					XMLProcessingInstruction = (0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLProcessingInstruction.js",
					);
					XMLDeclaration = (0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLDeclaration.js",
					);
					XMLDocType = (0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLDocType.js",
					);
					XMLDTDAttList = (0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLDTDAttList.js",
					...
					XMLAttribute = (0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLAttribute.js",
					);
					XMLStringifier = (0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLStringifier.js",
					...
					WriterState = (0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/WriterState.js",
					);
					module.exports = class {
						...
						attribute(name, value) {
							...
							if (isObject(name)) {
								...
								if (this.options.keepNullAttributes && null == value)
			...
			"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLElement.js"(
				...
				(function () {
					var NodeType,
						...
						isObject,
						hasProp = {}.hasOwnProperty;
					({ isObject, isFunction, getValue } = (0,
					_rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/Utility.js",
					));
					XMLNode = (0, _rslib_runtime_js__rspack_import_1.Q)(
					...
					module.exports = (() => {
						class XMLElement extends XMLNode {
							...
							getAttribute(name) {
								if (Object.hasOwn(this.attribs, name))
							...
							hasAttribute(name) {
								return Object.hasOwn(this.attribs, name);
							}
			...
			"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLNode.js"(
				...
				(function () {
					var DocumentPosition,
						...
						hasProp = {}.hasOwnProperty,
						splice = [].splice;
					({ isObject, isFunction, isEmpty, getValue } = (0,
					_rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/Utility.js",
					));
					XMLElement = null;
						...
						class XMLNode {
							constructor(parent1) {
								...
								if (!XMLElement) {
									...
									XMLDummy = (0, _rslib_runtime_js__rspack_import_1.Q)(
										"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLDummy.js",
									);
									NodeType = (0, _rslib_runtime_js__rspack_import_1.Q)(
										"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/NodeType.js",
									);
									XMLNodeList = (0, _rslib_runtime_js__rspack_import_1.Q)(
										"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLNodeList.js",
									);
									(0, _rslib_runtime_js__rspack_import_1.Q)(
										"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLNamedNodeMap.js",
									);
									DocumentPosition = (0, _rslib_runtime_js__rspack_import_1.Q)(
										"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/DocumentPosition.js",
									);
								}
							}
							...
							element(name, attributes, text) {
								...
								if (Array.isArray(name))
									...
									for (key in name)
										if (hasProp.call(name, key)) {
											...
											if (
												...
												0 === key.indexOf(this.stringify.convertAttKey)
											)
												...
												if (
													...
													if (
														...
														0 === key.indexOf(this.stringify.convertTextKey)
													)
									...
									lastChild =
										this.options.keepNullNodes || null !== text
											? !this.options.ignoreDecorators &&
												this.stringify.convertTextKey &&
												0 === name.indexOf(this.stringify.convertTextKey)
												? this.text(text)
												: !this.options.ignoreDecorators &&
														this.stringify.convertCDataKey &&
														0 === name.indexOf(this.stringify.convertCDataKey)
													? this.cdata(text)
													: !this.options.ignoreDecorators &&
															this.stringify.convertCommentKey &&
															0 ===
																name.indexOf(this.stringify.convertCommentKey)
														? this.comment(text)
														: !this.options.ignoreDecorators &&
																this.stringify.convertRawKey &&
																0 === name.indexOf(this.stringify.convertRawKey)
															? this.raw(text)
															: !this.options.ignoreDecorators &&
																	this.stringify.convertPIKey &&
																	0 ===
																		name.indexOf(this.stringify.convertPIKey)
																? this.instruction(
																		name.substr(
							...
							next() {
								var i;
								i = this.parent.children.indexOf(this);
								if (-1 === i || i === this.parent.children.length - 1)
									throw new Error(
							...
							debugInfo(name) {
								...
								if (
									null == name &&
									!(null != (ref1 = this.parent) ? ref1.name : void 0)
								)
									return "";
								if (null == name) return "parent: <" + this.parent.name + ">";
								if (!(null != (ref2 = this.parent) ? ref2.name : void 0))
									return "node: <" + name + ">";
								return (
							...
							compareDocumentPosition(other) {
								...
								if (this.isPreceding(other)) return DocumentPosition.Preceding;
							...
							treePosition(node) {
								...
								pos = 0;
								found = false;
								this.foreachTreeNode(this.document(), (childNode) => {
									pos++;
			...
			"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLStreamWriter.js"(
				...
				(() => {
					...
					XMLWriterBase = (0, _rslib_runtime_js__rspack_import_1.Q)(
						...
						class XMLStringifier {
							...
							assertLegalChar(str) {
								...
								if ("1.0" === this.options.version) {
									...
									if (void 0 !== this.options.invalidCharReplacement)
										str = str.replace(
											regex,
			...
			"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLWriterBase.js"(
				...
				(() => {
					var NodeType,
						...
						assign,
						hasProp = {}.hasOwnProperty;
					({ assign } = (0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/Utility.js",
					));
					NodeType = (0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/NodeType.js",
					...
					module.exports = class {
						...
						filterOptions(options) {
							...
							filteredOptions.spaceBeforeSlash =
								null !=
								(ref6 =
									null != (ref7 = options.spaceBeforeSlash)
										? ref7
										: options.spacebeforeslash)
									? ref6
									: "";
							if (true === filteredOptions.spaceBeforeSlash)
								filteredOptions.spaceBeforeSlash = " ";
						...
						attribute(att, options, level) {
							...
							r =
								options.pretty && options.width > 0
									? att.name + '="' + att.value + '"'
									: " " + att.name + '="' + att.value + '"';
						...
						declaration(node, options, level) {
							...
							if (null != node.encoding)
								r += ' encoding="' + node.encoding + '"';
							if (null != node.standalone)
						...
						dtdAttList(node, options, level) {
							...
							r +=
								...
								" " +
								node.attributeType;
							if ("#DEFAULT" !== node.defaultValueType)
			...
			"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/index.js"(
				...
				(() => {
					var NodeType,
						...
						assign,
						isFunction;
					({ assign, isFunction } = (0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/Utility.js",
					));
					XMLDOMImplementation = (0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLDOMImplementation.js",
					...
					XMLDocumentCB = (0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLDocumentCB.js",
					);
					XMLStringWriter = (0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLStringWriter.js",
					);
					XMLStreamWriter = (0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/XMLStreamWriter.js",
					);
					NodeType = (0, _rslib_runtime_js__rspack_import_1.Q)(
						"../../../node_modules/.pnpm/xmlbuilder@15.1.1/node_modules/xmlbuilder/lib/NodeType.js",
					...
					module.exports.create = (name, xmldec, doctype, options) => {
						...
						if (!options.headless) {
							...
							if (null != options.pubID || null != options.sysID)
								doc.dtd(options);
						}
						return root;
					};
		...
		function buffer_buffer(lengthOrField, converter) {
			...
			if (
				("object" == typeof lengthOrField ||
					"function" == typeof lengthOrField) &&
				...
				if (converter) {
					deserialize = function* (then, reader, context) {
						...
						const array =
							0 !== length ? reader.readExactly(length) : EmptyUint8Array;
						return converter.convert(yield* then(array));
					};
					init = (value) => converter.back(value);
				} else
					...
					switch (this.#segments.length) {
						...
						default:
							result = new Uint8Array(
								this.#segments.reduce((prev, item) => prev + item.length, 0),
							);
				...
				if (strategy) {
					...
					if ("size" in strategy)
						wrappedStrategy.size = (chunk) =>
							strategy.size(
								chunk instanceof consumable_Consumable ? chunk.value : chunk,
							);
				}
				super(
					{
			...
			constructor(source, strategy) {
				...
				if (strategy) {
					...
					if ("highWaterMark" in strategy)
						wrappedStrategy.highWaterMark = strategy.highWaterMark;
					if ("size" in strategy)
						wrappedStrategy.size = (chunk) => strategy.size(chunk.value);
				}
				super(
					{
						start(controller) {
		...
		const createTask = /* #__PURE__ */ (() =>
			console1?.createTask?.bind(console1) ??
			(() => ({
				run(callback) {
					return callback();
				},
		...
		function tryConsume(value, callback) {
			if (value instanceof consumable_Consumable)
				...
				serialize(source, bufferOrContext) {
					...
					const buffers = new Array(fieldList.length);
					{
						...
						for (const [index, [key, field]] of fieldList.entries())
							if ("byob" === field.type) sizes[index] = field.size;
							else {
		...
		const AdbReverseErrorResponse = extend(
			...
			{},
			{
				postDeserialize(value) {
					if ("more than one device/emulator" === value.content)
		...
		async function adbSyncWriteRequest(writable, id, value) {
			...
			if ("number" == typeof value)
				return void (await writable.write(
					AdbSyncNumberRequest.serialize({
						id,
						arg: value,
					}),
				));
		...
		const AdbSyncLstatResponse = struct_struct(
			...
			},
			{
				...
				postDeserialize(value) {
					if (0 === value.mode && 0 === value.size && 0 === value.mtime)
		...
		async function* adbSyncOpenDirV2(socket, path) {
			...
			try {
				...
				for await (const item of adbSyncReadResponses(
					...
					if (item.error === AdbSyncStatErrorCode.SUCCESS) yield item;
			} finally {
				locked.release();
			}
		}
						...
						await tryConsume(chunk, async (chunk) => {
							if (combiner)
								for (const buffer of combiner.push(chunk))
									await consumable_Consumable.ReadableStream.enqueue(
										controller,
										buffer,
									);
							else {
		...
		async function pipeFileData(locked, file, packetSize, mtime) {
			...
			file
				...
				.pipeTo(
					new MaybeConsumableWritableStream({
						write(chunk) {
		...
		class Adb {
			...
			rm(filenames, options) {
				...
				if (Array.isArray(filenames))
					for (const filename of filenames) args.push(escapeArg(filename));
		...
		const { setInterval: ref_setInterval, clearInterval: ref_clearInterval } =
			globalThis;
		class Ref {
			#intervalId;
			constructor(options) {
		...
		class AdbServerClient {
			...
			static parseDeviceList(
				value,
				includeStates = ["device", "unauthorized"],
			) {
				const devices = [];
			...
			async getDevices(includeStates = ["device", "unauthorized"]) {
			...
			async #waitForUnchecked(device, state, options) {
				let type;
				if (device)
					if ("transportId" in device) type = "any";
					...
					);
				{
					...
					return new Promise((resolve, reject) => {
						observer.onDeviceRemove((devices) => {
							if (
								devices.some((device) => device.transportId === transportId)
							) {
								observer.stop();
								resolve();
							}
		...
		const src = (0, _rslib_runtime_js__rspack_import_1.Q)(
			"../../../node_modules/.pnpm/debug@4.4.3/node_modules/debug/src/index.js",
		);
		...
		function android_ts_dispose_resources(env) {
			...
			return (android_ts_dispose_resources = (env) => {
				function fail(e) {
					env.error = env.hasError
						? new _SuppressedError(
								e,
		...
		class AndroidTransport {
			...
			async connect({ deviceId, port, signal }) {
				...
				debug(
					`connect: create connection to deviceId: ${deviceId}, port: ${port}`,
				);
				signal?.throwIfAborted();
				...
				try {
					...
					await adb.close();
					debug(
						`connect: create socket to ${service} failed with err: %o`,
						err,
					);
					throw err;
				}
			...
			async withConnection(options, callback) {
				...
				try {
					const conn = _ts_add_disposable_resource(
						env,
			...
			async listAvailableApps(deviceId) {
				...
				try {
					const adb = _ts_add_disposable_resource(
						env,
						await this.#createAdb(deviceId),
						true,
					);
			...
			async connect({ deviceId, port, signal }) {
				...
				try {
					...
					const { readable, writable } =
						node_stream__rspack_import_3.Duplex.toWeb(socket);
					return {
						readable,
						writable,
						[Symbol.asyncDispose]() {
					...
					desktop_debug(
						`connect: error connecting to 127.0.0.1:${port} %O`,
						err,
					);
					socket.destroy();
					throw err;
		...
		const dist = (0, _rslib_runtime_js__rspack_import_1.Q)(
			"../../../node_modules/.pnpm/usbmux-client@0.2.1/node_modules/usbmux-client/dist/index.js",
		);
		...
		function ios_ts_dispose_resources(env) {
			...
			return (ios_ts_dispose_resources = (env) => {
				function fail(e) {
					env.error = env.hasError
						? new _SuppressedError(
								e,
		...
		class iOSTransport {
			...
			async connect({ deviceId, port, signal }) {
				...
				const { readable, writable } =
					node_stream__rspack_import_3.Duplex.toWeb(conn);
				return {
					readable,
					writable: writable,
					[Symbol.asyncDispose]() {
			...
			async withConnection(options, callback) {
				...
				try {
					const conn = ios_ts_add_disposable_resource(
						env,
						await this.connect(options),
						true,
					);
	...
	"../../../node_modules/.pnpm/commander@14.0.3/node_modules/commander/esm.mjs"(
		...
		var _index_js__rspack_import_0 = __webpack_require__(
			"../../../node_modules/.pnpm/commander@14.0.3/node_modules/commander/index.js",
		);
		const {
			program,
